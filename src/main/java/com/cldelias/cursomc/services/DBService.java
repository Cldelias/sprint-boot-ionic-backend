...
import com.cldelias.cursomc.domain.Produto;
...
import com.cldelias.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instatiateTestDatabase( ) throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "clodoaldoelias@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "cldelias@bol.com.br", "75794895039", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("777777", "888888888"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "37777012", cli2, c2);
